...
class CI_DB_postgre_driver extends CI_DB {
	 ...
	 */function list_tables($constrain_by_prefix = FALSE)
	{
		...
		$retval = array();
		$query = $this->query("SELECT * FROM information_schema.tables");
	...
	function _list_columns($table = '')
	{
		...
		else
	    {
	        ...
	        $array = explode(".",$table);
	        $table_schema = $array[0];
	        $table_name = $array[1];
	        return "SELECT column_name FROM information_schema.columns WHERE table_name ='".$table_name."' and table_schema ='".$table_schema."' order by ordinal_position ";
	    }
	}
