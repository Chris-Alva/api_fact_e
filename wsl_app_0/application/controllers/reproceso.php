...
class reproceso extends CI_Controller{
    ...
    function reprocesar_comprobantes(){			$this->FuncionInicial();
		...
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_factura/".$this->db->database."/".$row->prefijo1."-".$row->prefijo2."-".$row->secuencia);	//break;
		...
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_factura/".$this->db->database."/".$row->prefijo."-".$row->factura_fiscal."/SIIS");
		...
		*/										$this->tipo_doc="06";	$query= $this->querys_model->GetDatosGuiaRemision();			//print_r($this->db->last_query());	echo "________";
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_guia/".$this->db->database."/".$row->prefijo1."-".$row->prefijo2."-".$row->secuencia);	//break;
		...
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_nc/".$this->db->database."/".$row->prefijo1."-".$row->prefijo2."-".$row->sec_nc);		//break;
		...
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_nc/".$this->db->database."/".$row->id."/SIIS");
		...
		*/										$this->tipo_doc="07";	$query= $this->querys_model->GetDatosRetencion();				//print_r($this->db->last_query());	echo "________";
		foreach($query->result() as $row):		shell_exec("/usr/bin/curl -k ".$this->arr_parametros["aplicativo_wsl_app"]."/index.php/proceso/generar_retencion/".$this->db->database."/".$row->prefijo1."-".$row->prefijo2."-".$row->secuencia);	//break;
